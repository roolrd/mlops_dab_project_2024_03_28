...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/my_mlops_project-tests-ci.yml) 
...
Links:
* [Staging model in UC](https://adb-5234076613698857.17.azuredatabricks.net/explore/data/models/staging/my_mlops_project/my_mlops_project-model)
* [Prod model in UC](https://adb-7787942769878562.2.azuredatabricks.net/explore/data/models/prod/my_mlops_project/my_mlops_project-model)
. 
